...
<template>
  <div>
    ...
    <div class="footer">
      <div>
        <h1 class="footer-header">Nepsap</h1>

        <p>Copyright © 2022 Designed And Developed By Manish Shrestha</p>
      </div>
      <div>
        ...
        <ul class="social-links">
          <li class="footer-links">
            <a
              ...
              class="social-link"
            >
              <p class="fab fa-facebook-f facebook-circle"></p>
          ...
          <li class="footer-links">
            <a
              ...
              class="social-link"
            >
              <p class="fab fa-linkedin-in linkedin-circle"></p>
          ...
          <li class="footer-links">
            <a
              ...
              class="social-link"
            >
              <p class="fab fa-google google-circle "></p>
